...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navDrawerItems.add(new NavDrawerItem(navMenuTitles[2], navMenuIcons.getResourceId(2, -1), true, "ใหม่"));
        navDrawerItems.add(new NavDrawerItem(navMenuTitles[3], navMenuIcons.getResourceId(3, -1), true, "ใหม่"));
        ...
        // enabling action bar app icon and behaving it as toggle button_exit
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // automatically handle clicks on the Home/Up button_exit, so long
        ...
        // update the main content by replacing fragments
            ...
            switch (position) {
                case 0:
                    ...
                    break;
                case 1:
                    fragment = new ChkBalanceFragment();
                    break;
                case 2:
